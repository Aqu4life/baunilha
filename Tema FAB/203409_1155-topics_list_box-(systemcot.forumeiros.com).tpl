...
<span>{L_LASTPOST}</span>
    ...
    <div class="posts-section">
        <div class="posts-icon {topics_list_box.row.FOLDER_CLASSNAME} {topics_list_box.row.TOPIC_READ_STATUS}" title="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" style="display: none;">
...
<i class="material-icons">groups</i>{topics_list_box.row.LAST_POST_AUTHOR}
</span>
