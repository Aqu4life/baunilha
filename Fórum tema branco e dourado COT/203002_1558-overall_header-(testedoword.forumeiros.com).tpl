                            ...
                            <div class="wrap">
                                   <div class="navbar-content">
                                    <ul class="navbar-links">
                                              ...
                                              <a href="/login" title="Iniciar sessão" class="user-item blue login-btn"><li><i class="fas fa-sign-in-alt"></i>Logar</li></a>
                                              <a href="/register" title="Registrar-se" class="user-item green"><li><i class="fas fa-user-plus"></i>Criar conta</li></a>
                                              <a href="/profile?mode=sendpassword" title="Esqueci minha senha" class="user-item red"><li><i class="fas fa-question"></i>Recuperar senha</li></a>
                                              <!-- END switch_user_logged_out -->
                                              <!-- BEGIN switch_user_logged_in -->
                                              <a href="/forum"><li><i class="fas fa-home"></i>Início</li></a>
                                              <a href="/f12-"><li><i class="fas fa-address-card"></i>Setor Administrativo</li></a>  
                                              <a href="/f13-"><li><i class="fas fa-gavel"></i>Setor Judiciário</li></a> 
                                                
                                              <a href="/groups"><li><i class="fas fa-user-friends"></i>Grupos</li></a>
                                              <a href="/memberlist"><li><i class="fas fa-address-book"></i>Membros</li></a>
                                              <a href="/calendar"><li><i class="fas fa-calendar-alt"></i>Calendário</li></a>
